...
import os
import sys
sys.path.insert(0, os.path.abspath('C:\\Users\\sleon\\repositorios\\prueba\\rindus-task\\src'))


# -- Project information -----------------------------------------------------

project = 'Rindus task'
copyright = '2019, Salvador Leon'
...
html_theme_options = {'logo': 'logo.svg', 'fixed_sidebar': True, 'description': 'Coding Task Rindus'}
